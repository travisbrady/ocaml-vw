...
(* OASIS_START *)
(* DO NOT EDIT (digest: 11b4004f37d2f367a2b14309ccc71ae0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/travisbrady/ocaml-vw";
          bugreports = Some "https://github.com/travisbrady/ocaml-vw/issues";
          synopsis = "Bindings for vowpal-wabbit";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "vw_stubgen.ml"});
               Library
                 ({
                     cs_name = "vw";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["vw_stubs.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-stdlib=libstdc++"])];
                      bs_cclib =
                        [
                   ...
                   },
                   {
                      lib_modules = ["Vw"];
                      lib_pack = false;
                      lib_internal_modules = ["Vw_bindings"; "Vw_generated"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "vw"];
                      bs_build_tools =
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/travisbrady/ocaml-vw.git";
                      src_repo_browser =
                        Some "https://github.com/travisbrady/ocaml-vw";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\252\139\129\204A\166\219\174<H\234z\028}\149\019";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
